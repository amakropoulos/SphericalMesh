...
#include "mirtk/SphereQuadrisect.h"
...
ParticleSampleSphere::ParticleSampleSphere(){
  _maxIterations=1000;
...
void ParticleSampleSphere::Initialize(){
}


void ParticleSampleSphere::SphericalCoordsOn(){
  _sphericalCoordsOn=true;
}

void ParticleSampleSphere::SphericalCoordsOff(){
  _sphericalCoordsOn=false;
}


void ParticleSampleSphere::SetNumberOfPoints(int numPoints){
  _numPoints=numPoints;
}

void ParticleSampleSphere::SetNumberOfSubdivisions(int subdivisions){
...
void ParticleSampleSphere::AddSphericalCoordScalars(vtkSmartPointer<vtkPolyData> mesh){
  //TODO fix this mess!
  int i;
  int numPoints;
...
void ParticleSampleSphere::OptimizeParticlePositions(vtkSmartPointer<vtkPoints> points){
  ...
  Matrix geodesicMatrix(numPoints,numPoints);
  Matrix dotMatrix(numPoints,numPoints);
...
/*
vtkSmartPointer<vtkPoints> ParticleSampleSphere::StratifiedSample(){
...
vtkSmartPointer<vtkPolyData> ParticleSampleSphere::GetSphere(){
  vtkSmartPointer<vtkPoints> points;
